...
// Overall score — this is a WORK-PRIORITIZATION signal only, the same editorial-but-deliberate
...
const QUEUE_COMMENT =
  ...
  'popularity never touches any Overall score). Rendered at the unlinked /queue page.'
