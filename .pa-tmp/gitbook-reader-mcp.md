> For the complete documentation index, see [llms.txt](https://gitbook.com/docs/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://gitbook.com/docs/ai-for-your-readers/mcp-servers-for-published-docs.md).
...
* If your site uses [authenticated access](/docs/publish/site-audience/authenticated-access.md), your tool must support the [MCP authorization spec](https://modelcontextprotocol.io/specification/2025-06-18/basic/authorization).
...
In the **Page actions** section of your [Customization](/docs/manage-your-site/customization.md) settings, you can enable the **Connect with MCP server** option. This lets visitors copy your site's MCP server URL from [the Page actions menu](/docs/manage-your-site/customization/extra-configuration.md#page-actions).

### Add the MCP link to your site

In [Site customization](/docs/manage-your-site/customization.md), open [Page actions](/docs/manage-your-site/customization/extra-configuration.md#page-actions). Make sure **Page actions** is turned on. Then turn on **Connect with MCP server**.
...
* [Auth0](/docs/publish/site-audience/authenticated-access/setting-up-auth0.md)
* [Azure AD](/docs/publish/site-audience/authenticated-access/setting-up-azure-ad.md)
* [Okta](/docs/publish/site-audience/authenticated-access/setting-up-okta.md)
* [AWS Cognito](/docs/publish/site-audience/authenticated-access/setting-up-aws-cognito.md)
* [OIDC](/docs/publish/site-audience/authenticated-access/setting-up-oidc.md)
* [Custom backend](/docs/publish/site-audience/authenticated-access/setting-up-a-custom-backend.md) with a configured Fallback URL
...
To set this up, start with [Authenticated access](/docs/publish/site-audience/authenticated-access.md) and [Enabling authenticated access](/docs/publish/site-audience/authenticated-access/enabling-authenticated-access.md).
...
```
GET https://gitbook.com/docs/ai-for-your-readers/mcp-servers-for-published-docs.md?ask=<question>&goal=<endgoal>
```
