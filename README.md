...
<!-- stats:start -->
As of the last full pipeline run: **30 arenas, 154 products, 9,921 judged verdicts.**
<!-- stats:end -->
...
| AI Coding Agents (`ai-coding`) | codex, claude-code, cursor, github-copilot, gemini-cli, devin, aider, cline |
...
| Local LLM Runtimes (`local-llm-runtimes`) | ollama, llama-cpp, vllm, lm-studio, jan, llamafile |
...
| Agent Frameworks & SDKs (`agent-frameworks`) | langgraph, openai-agents, claude-agent-sdk, crewai, pydantic-ai, mastra, autogen, smolagents |
