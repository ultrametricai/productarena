...
**Evidence in, rankings out.** INIT scores how AI-ready real products are — every verdict
cites the evidence behind it, nothing is opinion.

[![CI](https://github.com/ultrametricai/initdotdog/actions/workflows/ci.yml/badge.svg)](https://github.com/ultrametricai/initdotdog/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](./LICENSE)
[![site](https://img.shields.io/badge/site-init.dog-000000)](https://init.dog)

![INIT](https://init.dog/opengraph-image)
...
<!-- stats:start -->
As of the last full pipeline run: **11 arenas, 57 products, 4,141 judged verdicts.**
<!-- stats:end -->
...
The current #1 by INIT Score in each arena (see "The INIT Score" below for what that number
...
| Project Management | Linear | 36.6 |
| Web Scraping APIs | Apify | 41.1 |
| Mobile AI Dev Tools | Working Copy | 16.2 |
| Code Hosting | GitLab | 32.3 |
| AI Coding Agents | Claude Code | 39.7 |
| Edge & App Platforms | Cloudflare Workers | 37.8 |
| Frontend Frameworks | Svelte | 35.5 |
| Local LLM Runtimes | vLLM | 31.4 |
...
```bash
git clone https://github.com/ultrametricai/initdotdog.git && cd initdotdog
pnpm install
...
```bash
curl https://init.dog/data/categories.json
curl https://init.dog/data/ai-coding/rankings.json
curl https://init.dog/llms.txt          # index for agents
```
...
```json
{
  "mcpServers": {
    "init": {
      "command": "node",
      "args": ["/absolute/path/to/initdotdog/mcp/dist/index.js"]
    }
  }
}
```
...
directly: [new contest-verdict issue](https://github.com/ultrametricai/initdotdog/issues/new?template=contest-verdict.yml) —
...
as [GitHub releases](https://github.com/ultrametricai/initdotdog/releases) (e.g.
