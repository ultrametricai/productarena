...
INIT is an evidence-based comparison site: evidence in, rankings out. For each of ten-plus
...
INIT is live at **[init.dog](https://init.dog)** and under active expansion. In flight:
