...
// adoption data, not a judged verdict, and must never read as part of the Overall score (same
// stance as components/MomentumChip.tsx).
export default function HotChip({ reason }: { reason: string }) {
  return (
    <span
      title={`Hot right now: ${reason} — from public registry data, not part of the Overall score.`}
