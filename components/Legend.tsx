...
// battle views. Three labeled clusters instead of one undifferentiated pill strip — each cluster
// answers a different question (what the judge ruled / how strong the receipts are / what the
// compact glyphs mean), so a reader can find the vocabulary they're actually squinting at.
