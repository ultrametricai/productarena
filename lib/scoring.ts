...
// The Overall score (internally `aiEra`, formerly displayed as "AI-Era Index") blends five
...
// themeScores['automation-depth']). Weights are deliberately contestable — see README's "Arena
...
export function buildRankings(
  ...
  const leaderboard: LeaderboardEntry[] = products
    ...
    // Primary sort is the Overall score (nulls last — a product with no agent-readiness signal at
