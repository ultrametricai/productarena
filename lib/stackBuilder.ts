...
export const STACK_PRESETS: StackPreset[] = [
  {
    id: 'solo-founder',
    label: 'Solo founder',
    description: 'The whole company in six tools, picked by overall Overall score.',
  ...
  },
  {
    id: 'oss-purist',
    label: 'OSS purist',
    description: 'Open-source only, self-hostable preferred, ranked by Overall score.',
