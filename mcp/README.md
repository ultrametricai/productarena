...
A stdio [MCP](https://modelcontextprotocol.io) server exposing [Product Arena](https://productarena.vercel.app)'s
...
Data source: fetches `https://productarena.vercel.app/data/...` at call time (no local
...
```json
{
  "mcpServers": {
    "productarena": {
      ...
      "env": {
        "PA_BASE_URL": "https://productarena.vercel.app"
      }
    }
  }
}
