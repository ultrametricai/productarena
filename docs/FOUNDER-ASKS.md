...
| 'Technologies' ranking set: abstract control surfaces (API, CLI, MCP, terminal vs app…) as a 'Control surfaces' arena with toggles like 'Most mobile' / 'Most visual', AI/agentic-focused | in-lane (technologies-v1 — /technologies computed from existing judged fleet data; unsupported toggles honestly omitted) |
